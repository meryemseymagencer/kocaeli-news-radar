"""
Ses Kocaeli (seskocaeli.com) haber scraper modülü.
...
SITE_ADI = "seskocaeli.com"

# Haber linkleri toplanacak sayfalar
KAYNAK_SAYFALAR = [
    BASE_URL + "/",
    BASE_URL + "/kocaeli-son-dakika-haberler",
...
HABER_URL_PATTERN = re.compile(
    r"^https?://www\.seskocaeli\.com/(haber|foto|video)/\d+/.+"
)
...
def scrape() -> Dict[str, int]:
    ...
    logger.info(
        "═══ Ses Kocaeli scraping tamamlandı ═══\n"
        "  Toplam link  : %d\n"
        "  Eklenen      : %d\n"
        "  Mevcut (atl.): %d\n"
        "  Tarih dışı   : %d\n"
